...
> [`classroom_steps/`](./classroom_steps/) — each folder is a complete snapshot
...
```bash
cd 05.strands-support-react-aws
...
[`classroom_steps/10_agentcore_chat/architecture/`](./classroom_steps/10_agentcore_chat/architecture/)
