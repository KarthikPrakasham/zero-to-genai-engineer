#!/usr/bin/env python3
"""
Generate classroom_steps/01..10 — cumulative, self-contained folders.

Run from lab root or this directory:
  python3 classroom_steps/_generate.py
