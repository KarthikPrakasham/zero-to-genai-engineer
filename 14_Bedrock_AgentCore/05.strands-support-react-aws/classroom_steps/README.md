# Classroom steps — 10 folders, learn by growing the app
...
cd classroom_steps/01_empty_cdk && bash deploy.sh
...
## Note vs parent `cdk/` staged `-c stage=N`

The parent [`cdk/`](../cdk/) app uses **one** codebase with stage flags.  
See [`../CLASSROOM_10_CDK_DEPLOYS.md`](../CLASSROOM_10_CDK_DEPLOYS.md).
