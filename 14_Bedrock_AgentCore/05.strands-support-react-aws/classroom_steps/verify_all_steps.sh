#!/usr/bin/env bash
# Deploy classroom_steps 01→10 and verify each step.
# Usage (from lab root, with AWS creds already exported):
#   bash classroom_steps/verify_all_steps.sh
set -euo pipefail

LAB="$(cd "$(dirname "$0")/.." && pwd)"
STEPS_DIR="$LAB/classroom_steps"
